...
<head>
  ...
  <title>potrzebuje.pl – practical AI/LLM training and implementations</title>

  <meta name="description" content="Practical AI/LLM training. We show how to use AI in daily work – from needs analysis, through workflows, to implementations." />
<style>
  /* ===== Reset ===== */
...
<body>
  ...
  <div id="top" class="page">
    ...
    <div class="hero">
      <div>
        <h1>AI is everywhere. But most people still don’t know how to use it sensibly at work.</h1>
        <p>
          We deliver <strong>hands-on AI/LLM training</strong> and help implement tools
          that measurably improve everyday tasks. No fluff, no “slide show”.
        </p>

        <div class="hero-actions">
          <a class="btn btn-primary" href="/contact.php?lang=en">Book a call / ask a question</a>
          <a class="btn btn-secondary" href="#demo">See the mini demo</a>
        </div>

        <div class="note" style="margin-top:10px;">
          If you’re not sure where to start, describe your situation — we’ll structure it and propose a sensible direction.
        </div>
      </div>
      ...
      <div class="hero-card">
        ...
        <ul class="hero-bullets">
          <li><strong>Tailored:</strong> fit to role, industry, and team level</li>
          <li><strong>Practice:</strong> workflows, prompt engineering, automation</li>
          <li><strong>Safe:</strong> constraints, risks, policies, best practices</li>
        </ul>
      </div>
    </div>
    ...
    <div id="oferta" class="section">
      <div class="section-title">Offer – praktyczne szkolenia i wdrożenia</div>
      <div class="section-sub">
        We focus on what delivers results: processes, tools, and measurable improvements.
        Below are the most common ways we work.
      </div>

      <div class="grid">
        <div class="card">
          <h3>1) Training: “AI in everyday work”</h3>
          <p>From basics to practice: using LLMs for analysis, writing, summarising, planning, and task automation.</p>
          <div class="chip-row">
        ...
        <div class="card">
          <h3>2) Prompt engineering as a process</h3>
          <p>We teach prompt design, result verification, and building reusable templates for your use-cases.</p>
          <div class="chip-row">
        ...
        <div class="card">
          <h3>3) Mini-implementations (workflow + automation)</h3>
          <p>We map the process, pick 2–3 improvement points, and implement a solution (without a “big project”).</p>
          <div class="chip-row">
    ...
    <div id="demo" class="section">
      <div class="section-title">Mini demo: how AI/LLM structures a problem</div>
      <div class="section-sub">
        Describe your problem briefly (2–6 sentences). We’ll show an example analysis and follow-up questions.
        This demo runs live via an LLM (o4-mini) with limits: 20 words per question, up to 100 words per answer, 100 requests/day.
      </div>

      <div class="demo">
        <div>
          <textarea id="demoInput" placeholder="E.g. The team wants to use AI, but everyone does it differently. We do not know where to start."></textarea>

          <div class="hero-actions" style="margin-top:12px;">
            <button class="btn btn-primary" type="button" id="demoBtn">Run AI demo</button>
            <button class="btn btn-secondary" type="button" id="demoExampleBtn">Insert example</button>
          </div>

          <div class="note">
            In the full version (new Potrzebuje.pl) this will run automatically via LLM and store results.
          </div>
        </div>
        ...
        <div class="demo-panel">
          <div class="demo-panel-head">
            ...
            <span class="chip" id="demoBadge">ready</span>
...
Type your question on the left and click “Run AI demo”.
</div>
        </div>
      </div>
    </div>
    ...
    <div id="o-nas" class="section">
      <div class="section-title">About – jak naprawdę pracujemy z AI/LLM</div>
      <div class="section-sub">
        We don’t teach “how to chat with ChatGPT”. We teach how to build repeatable solutions and safe workflows.
      </div>
      ...
      <div class="grid">
        <div class="card">
          <h3>What we do</h3>
          <p>
            We design training “by role”: different for managers, specialists, and IT teams.
            We base it on practical tasks from your context.
          </p>
        </div>

        <div class="card">
          <h3>What we show (concretely)</h3>
          <p>
            Differences: model vs tool, prompt as a process, quality checks, limitations (hallucinations, bias),
            costs, and security best practices.
          </p>
        </div>

        <div class="card">
          <h3>What you get after training</h3>
          <p>
            Checklists, prompt templates, example workflows, and a plan to implement 2–3 improvements “for tomorrow”.
          </p>
        </div>
      </div>
    </div>
    ...
    <!-- CTA końcowe -->
    <div class="section">
      <div class="section-title">Want training “so you actually learn”?</div>
      <div class="section-sub">
        Write briefly: who the audience is, what problem you want to solve, and your time/budget.
        We’ll reply with a proposed format (online/onsite) and a plan.
      </div>
      <div class="hero-actions">
        <a class="btn btn-primary" href="/contact.php?lang=en">Go to contact</a>
        <a class="btn btn-secondary" href="#demo">See the demo first</a>
      </div>
    </div>

    <div class="footer">
      <div>© potrzebuje.pl</div>
      <div>AI/LLM – training and practical implementations</div>
    </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      btn.addEventListener("click", async function () {
        ...
        if (used >= MAX_DAILY_CALLS) {
          badge.textContent = T.limit;
          out.textContent = "Limit dzienny demo został przekroczony (100 zapytań). Spróbuj jutro lub użyj CONTACT.";
          updateLimitsDisplay(out.textContent);
          return;
        }
        ...
        try {
          const res = await fetch("/demo_api.php", {
            ...
            body: JSON.stringify({ question: raw, lang: "en" })
          });
